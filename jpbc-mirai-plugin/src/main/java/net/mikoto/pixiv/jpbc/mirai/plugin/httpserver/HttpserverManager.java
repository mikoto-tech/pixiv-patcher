package net.mikoto.pixiv.jpbc.mirai.plugin.httpserver;

import com.sun.net.httpserver.HttpServer;
import net.mikoto.pixiv.jpbc.mirai.plugin.controller.ControllerEntry;

import java.io.*;
import java.net.InetSocketAddress;

import static net.mikoto.pixiv.jpbc.mirai.plugin.JpbcMiraiPlugin.HTTP_API_PORT;
import static net.mikoto.pixiv.jpbc.mirai.plugin.util.HttpUtil.formData2Dic;
