...
import net.mikoto.pixiv.jpbc.mirai.plugin.controller.impl.JpbcInfoControllerImpl;
import net.mikoto.pixiv.jpbc.mirai.plugin.controller.impl.RegisterClientControllerImpl;
import net.mikoto.pixiv.jpbc.mirai.plugin.controller.impl.RegisterQqControllerImpl;
import net.mikoto.pixiv.jpbc.mirai.plugin.httpserver.HttpserverManager;
import net.mikoto.pixiv.jpbc.mirai.plugin.view.impl.JpbcInfoViewImpl;
import net.mikoto.pixiv.jpbc.mirai.plugin.view.impl.RegisterClientViewImpl;
import net.mikoto.pixiv.jpbc.mirai.plugin.view.impl.RegisterQqViewImpl;
...
public class JpbcMiraiPlugin extends JavaPlugin {
    ...
    public static final String PACKAGE = "net.mikoto.pixiv.jpbc.mirai.plugin";
