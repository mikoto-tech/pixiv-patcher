...
import net.mikoto.pixiv.jpbc.mirai.plugin.client.Client;
import net.mikoto.pixiv.jpbc.mirai.plugin.client.ClientManager;
import net.mikoto.pixiv.jpbc.mirai.plugin.controller.RegisterClientController;
...
public class RegisterClientControllerImpl extends RegisterClientController {
    ...
    protected void registerClient(HttpExchange httpExchange, Map<String, String> fromData) throws IOException {
        ...
        if (callbackIp != null) {
            ...
            Client client = ClientManager.getInstance().getUnverifiedClientByKey(ClientManager.getInstance().registerClient(callbackIp, callbackPort));
