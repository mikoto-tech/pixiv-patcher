...
public interface ArtworkPatcherService extends PatcherService<Artwork> {
    ...
    @Override
    void store(Artwork source, Cache<Artwork> cache, ArtworkConnector connector) throws IOException, NoSuchMethodException, InvocationTargetException, IllegalAccessException;
}
