...
public class ArtworkPatcherController {
    ...
    public JSONObject stopPatcher(@NotNull String key) {
        JSONObject outputJsonObject = new JSONObject();
        if (key.equals(patcherConfig.getKey())) {
            startFlag = false;
        } else {
            outputJsonObject.put("success", false);
            outputJsonObject.put("msg", "Wrong key.");
        }
    ...
    public JSONObject initPatcher(@NotNull String key) {
        JSONObject outputJsonObject = new JSONObject();
...
//            }
    ...
    public JSONObject startPatcher(@NotNull String key) {
        JSONObject outputJsonObject = new JSONObject();
        // 是否初始化
        if (key.equals(patcherConfig.getKey())) {
            if (initFlag) {
